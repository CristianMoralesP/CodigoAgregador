...
namespace Agregador
{
    public partial class ProductosDescartados : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (validarPagina())
                {
                    ...
                    Session["paginaAnterior"] = "ProductosDescartados";
                }
                else
        ...
        private void listarProductos(string termino)
        {
            ...
            new BOProductos().listarProductos(ref dtProductos, 4, 0, termino);
        ...
        protected void grProductos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("detalleProductoDescartado.aspx");
        }
