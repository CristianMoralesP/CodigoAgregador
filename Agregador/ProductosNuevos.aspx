<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="ProductosNuevos.aspx.cs" Inherits="Agregador.ProductosNuevos" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Administración de publicación y productos <i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Productos nuevos
            </h1>
