<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="ProductosAnteriores.aspx.cs" Inherits="Agregador.ProductosAnteriores" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Administración de publicación y productos <i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Productos anteriores
            </h1>
