...
namespace Agregador
{
    public partial class ProductosNuevos : System.Web.UI.Page
    {
        ...
        private void listarProductos(string termino)
        {
            ...
            new BOProductos().listarProductos(ref dtProductos, 1, 0, termino);
        ...
        protected void grProductos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("detalleProductoNuevo.aspx");
        }
