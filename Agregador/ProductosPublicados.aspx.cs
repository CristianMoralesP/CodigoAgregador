...
namespace Agregador
{
    public partial class ProductosPublicados : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (validarPagina())
                {
                    ...
                    Session["paginaAnterior"] = "ProductosPublicados";
                }
                else
        ...
        private void listarProductos(string termino)
        {
            ...
            new BOProductos().listarProductos(ref dtProductos, 2, 0, termino);
        ...
        protected void grProductos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("detalleProductoPublicado.aspx");
        }
