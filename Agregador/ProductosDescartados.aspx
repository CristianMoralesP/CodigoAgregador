<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="ProductosDescartados.aspx.cs" Inherits="Agregador.ProductosDescartados" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Administración de publicación y productos <i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Productos descartados
            </h1>
    ...
    <div class="row">
        <asp:GridView ID="grProductos" runat="server" DataKeyNames="id" OnSelectedIndexChanged="grProductos_SelectedIndexChanged" AutoGenerateColumns="false" GridLines="None"  AllowPaging="true" PageSize="50" OnPageIndexChanging="grProductos_PageIndexChanging" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AllowSorting="True" OnSorting="grProductos_Sorting">
            <Columns>
                ...
                <asp:BoundField HeaderText="Valor del Catálogo" DataField="listPrice"/>
